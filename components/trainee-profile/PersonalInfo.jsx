  ...
  return (
    <div className="bg-white rounded-2xl shadow-lg p-8 border border-gray-100">
      <div className="flex items-center justify-between mb-6">
        <h2 className="text-2xl font-bold text-[#002B5B]">Personal Information</h2>
        <button 
          onClick={() => router.push(`/edit/${userId}/edit-profile`)} 
          className="inline-flex items-center gap-2 bg-[#FE9900] text-white px-4 py-2 rounded-lg hover:bg-[#F8C400] transition-colors font-medium"
        >
